        ...
        <form method="post" id="user_form" enctype="multipart/form-data">
          <div class="modal-content">
                           ...
                           <select name="article_pro" id="article_pro" class="form-control">
                            ...
                            if ($articles->num_rows() > 0) {
                              ...
                              foreach ($articles->result_array() as $key) {
                                ?>
                                <option value="<?php echo($key['idart']) ?>"><?php echo(substr($key['nom'], 0,35)) ?>...</option>
                                <?php
                              }
                            }
                            else{
            ...
            <div class="modal-footer">
                <input type="hidden" name="idcomment" id="idcomment" placeholder="idcomment">
                <input type="hidden" name="idart" id="idart" placeholder="idart">
     ...
     $(document).ready(function(){  
      ...
      var  $message = '';
          ...
          $('#add_button').click(function(){  
               $('#user_form')[0].reset();  
               $('.modal-title').text("Paramètrage des commentaires des blogs");  
               $('#action').val("Add"); 
