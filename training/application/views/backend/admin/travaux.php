      ...
      $(document).ready(function() {
         ...
         $(document).on('submit', '#user_form', function(event){  
               ...
               if(nomtravail != '' && descriptiontravail != '' && idlesson != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_travail'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_travail'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_travail",  
                    method:"POST",  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
            {
                ...
                $.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_travail",
                      method:"POST",
                      data:{idtravail:idtravail},
                      success:function(data)
                      {
          ...
          $(document).on('change', '#cours', function(){
              ...
              if(idcours != '')
              {
                // alert(idcours);
                 $.ajax({
                    url:"<?php echo base_url(); ?>admin/fetch_lesson_requete",
                    method:"POST",
          ...
          */
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_travail/",
             method:"GET",
              beforeSend:function()
              {
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_travail",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
         ...
         $(document).on('change', '#limit', function(event) {
              ...
              if (limit !='') {
                $.ajax({
                  url: '<?php echo base_url(); ?>admin/fetch_limit_view_travail',
                  type: 'POST',
                  data: {limit: limit},
                  beforeSend:function()
                  {
         ...
         */
         ...
         function showPagination_travaux(page)
         {
            ...
            if (idtravail != '') {
                ...
                $.ajax({
                  url:"<?php echo base_url(); ?>admin/pagination_travaux_remis/"+page,
                  method:"POST",
                  dataType:"json",
                  data:{idtravail:idtravail},
                  beforeSend:function()
