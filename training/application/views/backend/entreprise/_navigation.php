            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/entreprise">Entreprise</a>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/galerie">Galerie</a>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/type">Type</a>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/chambre">Chambre</a>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/client">Client</a>

                        <div class="dropdown-divider"></div>
                        <a class="collapse-item" href="<?php echo(base_url()) ?>entreprise/stat_filtrage_galerie_ap">Liste des Galeries</a>
