    ...
    <!-- fin modal-->
     ...
     $(document).ready(function(){  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'entreprise/fetch_stade'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nom != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'entreprise/operation_stade'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'entreprise/modification_stade'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>entreprise/fetch_single_stade",  
                    method:"POST",  
              ...
              if(confirm("Are you sure you want to delete this?"))
		          {
		           		...
		           		$.ajax({
	                    url:"<?php echo base_url(); ?>entreprise/supression_stade",
	                    method:"POST",
	                    data:{idstade:idstade},
	                    success:function(data)
	                    {
