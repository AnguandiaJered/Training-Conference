      ...
      $(document).ready(function() {
         ...
         $(document).on('submit', '#user_form', function(event){  
               ...
               if(nomlesson != '' && descriptionlesson != '' && idcours != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'formateur/operation_lesson'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'formateur/modification_lesson'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>formateur/fetch_single_lesson",  
                    method:"POST",  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
            {
                ...
                $.ajax({
                      url:"<?php echo base_url(); ?>formateur/supression_lesson",
                      method:"POST",
                      data:{idlesson:idlesson},
                      success:function(data)
                      {
          ...
          */
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>formateur/pagination_view_lesson/",
             method:"GET",
              beforeSend:function()
              {
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>formateur/fetch_search_view_lesson",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
         ...
         $(document).on('change', '#limit', function(event) {
              ...
              if (limit !='') {
                $.ajax({
                  url: '<?php echo base_url(); ?>formateur/fetch_limit_view_lesson',
                  type: 'POST',
                  data: {limit: limit},
                  beforeSend:function()
                  {
